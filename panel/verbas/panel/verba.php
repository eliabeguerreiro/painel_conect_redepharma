                ...
                <p class="p-2" style="color: #8f1838; font-weight: bold; font-size: 20px;"></p>
                    <center>
                        <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <label>Valor</label>
                            <div class="col-md-8">
                                <input class="form-control" type="number" step='0.01' min="10" max="10000000" name="valor"
                                    placeholder="Digite o válor da verba">
                                <small id="emailHelp" class="form-text text-muted"></small>
                            </div>
                            <br>
                            <br>
                            ...
                            <input id="arquivo" name="arquivo" class="col-md-8 input-file form-control" type="file"><br>
                            <br>
