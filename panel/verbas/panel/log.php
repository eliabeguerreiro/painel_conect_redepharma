...
<body> 
    <div style="position: relative; width: 100%;">
        ...
        if($_GET){
            ...
            $sqlL = "SELECT * FROM log_verba  LIMIT $inicio, $qnt_result_pg";
            ...
            while ($log = mysqli_fetch_assoc($sqlLog)){
                ...
                echo("<tr>");
                echo("<td>ID do item: ".$log['id_altera']."</td>");
                $sqlu = "SELECT * FROM usuarios WHERE id_user = '".$log['id_user']."'";
                $sqlus = mysqli_query($conn, $sqlu);
                $user = mysqli_fetch_assoc($sqlus);
                echo("<td>ID do usuario: ".$user['nome']."</td>");
                echo("<td>Descrição da ação: ".$log['nome']."</td>");
            ...
            if($sqlLog){
                ...
                $result_pg = "SELECT COUNT(*) AS num_result FROM log_verba";
