    ...
    <section class="header">
        <div class="hub">
            ...
            <div class="btn_container">
                <div onclick="location.href='./inventario'" class="btn_box">
                    <div class="btn_icon"></div>
                    <div class="btn_name">Inventário</div>
                </div>
                <div onclick="location.href='./integrador_delivery'" class="btn_box" style="cursor: not-allowed;">
                    <div class="btn_icon"></div>
                    <div class="btn_name">Delivery</div>
                    <small>*desenvolvimento*</small>
                </div>
                <div onclick="location.href='./verbas/panel/'" class="btn_box">
                    <div class="btn_icon"></div>
                ...
                <div onclick="location.href='../index.php'" class="btn_box">
                    <div class="btn_icon"></div>
